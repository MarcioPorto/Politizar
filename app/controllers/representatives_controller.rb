class RepresentativesController < ApplicationController
  ...
  private
    ...
    def representative_params
      params.require(:representative).permit(:identifier, :name, :full_name, :gender, :photo, :email, :total_sessions, :present_sessions, :justified_absences, :unjustified_absences, :last_presence_update, :party_id, :region_id, :institution_id)
    end
end
